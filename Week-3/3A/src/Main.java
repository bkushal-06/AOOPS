public class Main {
    public static void main(String[] args) {
        ...
        // Decorator Pattern
        MusicPlayer basicMusicPlayer = new BasicMusicPlayer();
        MusicPlayer equalizerMusicPlayer = new EqualizerDecorator(basicMusicPlayer);
        MusicPlayer volumeControlMusicPlayer = new VolumeControlDecorator(equalizerMusicPlayer);

        volumeControlMusicPlayer.play();
    }
}
